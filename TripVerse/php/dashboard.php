...
<body>
    ...
    <main class="main-content" id="main-content">
        ...
        <div class="dss-section">
            <h2><i class="material-icons">dashboard</i> Data Visualization - TripVerse Admin</h2>
            ...
            <div class="kpi-grid">
                ...
                <div class="kpi-card warning">
                    ...
                    <div class="kpi-value"><?= $dss_stats['average_los'] ?> Hari</div>
                    <div class="kpi-trend trend-up">
        ...
        <div class="dss-section">
            <h2><i class="material-icons">trending_up</i> Booking Trends & Revenue Analysis</h2>
            <div class="dss-grid">
                <div class="dss-card">
                    <h3><i class="material-icons">show_chart</i> Monthly Booking Trends</h3>
                ...
                <div class="dss-card">
                    <h3><i class="material-icons">bar_chart</i> Monthly Revenue</h3>
                    <div class="chart-container">
        ...
        <div class="dss-section">
            <h2><i class="material-icons">room_service</i> Room Availability Analysis</h2>
            <div class="dss-grid">
                <div class="dss-card">
                    <h3><i class="material-icons">pie_chart</i> Overall Room Stock</h3>
                    <div class="chart-container">
                ...
                <div class="dss-card">
                    <h3><i class="material-icons">stacked_bar_chart</i> Room Availability by Type</h3>
                    <div class="chart-container">
        ...
        <div class="dss-section">
            <h2><i class="material-icons">business</i> Top Performing Hotels</h2>
            <table class="performance-table">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4">No hotel performance data available</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="booking-list-section">
            <div class="booking-list-header">
                <h2><i class="material-icons">list_alt</i> Booking List</h2>
                <div class="header-actions">
                </div>
            </div>
            ...
            <div class="search-filter-section">
                <div class="form-group">
                    <input type="text" id="searchHotel" placeholder="Search hotel or customer..."
                        onkeyup="applyFilters()" onfocus="this.placeholder=''"
                        onblur="this.placeholder='Search hotel or customer...'">
                </div>
                <div class="form-group">
                        ...
                        <div class="booking-card <?= $statusClass ?>"
                            ...
                            <div class="booking-card-header">
                                <div class="booking-meta">
                                    ...
                                    <span class="booking-nights"><?= $nights ?> malam</span>
                            ...
                            <div class="booking-footer">
                                ...
                                <div class="booking-actions">
                                    <button class="action-btn view-detail-btn" title="View Details" data-booking-id="<?= $booking['booking_id'] ?>">
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            viewDetailContent.innerHTML = `
                                ...
                                <div class="detail-section">
                                    <h3><i class="material-icons">business</i> Booking Details</h3>
                                    <div class="detail-grid">
                                        <div class="detail-item">
                                ...
                                <div class="detail-section">
                                    <h3><i class="material-icons">info</i> Booking Status</h3>
                                    <div class="detail-grid">
                                        <div class="detail-item">
                                ...
                                <div class="detail-section">
                                    <h3><i class="material-icons">notes</i> Special Requests</h3>
                                    <div class="detail-item">
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            editBookingContent.innerHTML = `
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        <label for="jumlah_kamar">Number of Rooms</label>
                                ...
                                <div class="form-group">
                                    <label for="catatan">Special Requests / Notes</label>
                                    <textarea class="form-control" id="catatan" name="catatan" rows="3" placeholder="Any special requests or notes...">${escapeHtml(booking.special_requests || '')}</textarea>
                                </div>
                            `;
                        } else {
                            editBookingContent.innerHTML = `
