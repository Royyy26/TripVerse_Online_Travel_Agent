...
<body>
    ...
    <main class="main-content" id="main-content">
        ...
        <div class="promo-section">
            <h2><i class="material-icons">assessment</i> Promo Statistics Overview</h2>
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Active Promo</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Inactive Promo</div>
        ...
        <div class="action-bar">
            <div class="search-container">
                <input type="text" id="searchPromo" class="search-input" placeholder="Search promo by name or code..."
        ...
        <!-- Promo List -->
        <div class="promo-section">
            <h2><i class="material-icons">list</i> Promo List</h2>
                        ...
                        <?php if ($promo_result && $promo_result->num_rows > 0): ?>
                            ...
                            ?>
                                <tr data-promo-id="<?= $promo['diskon_id'] ?>" data-promo-name="<?= htmlspecialchars($promo['nama_diskon']) ?>">
                                    ...
                                    <td>
                                        <?= $promo['kuota'] ? number_format($promo['kuota']) : 'Unlimited' ?>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" onclick="openUsageModal('<?= $promo['diskon_id'] ?>', '<?= htmlspecialchars($promo['nama_diskon']) ?>')" class="text-primary" title="View usage details">
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <button class="action-btn usage-btn" onclick="openUsageModal('<?= $promo['diskon_id'] ?>', '<?= htmlspecialchars($promo['nama_diskon']) ?>')" title="View Usage">
                                                <i class="material-icons">people</i>
                                            </button>
                                            <button class="action-btn toggle-btn" onclick="togglePromoStatus('<?= $promo['diskon_id'] ?>', '<?= $promo['status'] ?>')" title="<?= $promo['status'] == 'active' ? 'Deactivate' : 'Activate' ?>">
                                                <i class="material-icons">
