...
<td style="background:linear-gradient(135deg,#0F172B 0%,#1e3a5f 50%,#2d5a87 100%);padding:40px 32px 32px;text-align:center;">
    ...
    <tr><td align="center">
        ...
        <p style="margin:8px 0 0;font-size:14px;color:rgba(255,255,255,0.7);font-weight:400;">Verifikasi Keamanan Akun</p>
    </td></tr>
    </table>
</td>
</tr>
...
<td style="padding:36px 32px;">
    <p style="margin:0 0 8px;font-size:16px;color:#1a1a2e;font-weight:600;">Halo! 👋</p>
    <p style="margin:0 0 28px;font-size:14px;color:#64748b;line-height:1.7;">
        Kami menerima permintaan untuk mereset password akun TripVerse Anda. Gunakan kode OTP di bawah ini untuk melanjutkan proses verifikasi.
    </p>
...
<td style="padding:24px 32px 32px;text-align:center;">
    <p style="margin:0 0 4px;font-size:13px;color:#94a3b8;">Tidak meminta kode ini?</p>
    <p style="margin:0 0 20px;font-size:12px;color:#94a3b8;">Abaikan email ini. Akun Anda tetap aman.</p>
