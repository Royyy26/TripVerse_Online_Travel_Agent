    ...
    <main class="main-content" id="main-content">
        ...
        <div class="page-header">
            <h1>
                ...
                <?= te('Manajemen Persetujuan Supplier') ?>
            </h1>
            <p><?= te('Tinjau dan kelola permintaan pendaftaran supplier') ?></p>
        </div>

        <div class="stats-grid">
            <div class="stat-card pending">
                <h3><?= te('Permintaan Tertunda') ?></h3>
                <div class="value"><?= $pendingCount ?></div>
                <div class="sub-value"><?= te('Menunggu tinjauan') ?></div>
            </div>
            <div class="stat-card approved">
                <h3><?= te('Disetujui') ?></h3>
                <div class="value"><?= $approvedCount ?></div>
                <div class="sub-value"><?= te('Supplier aktif') ?></div>
            </div>
            <div class="stat-card rejected">
                <h3><?= te('Ditolak') ?></h3>
                <div class="value"><?= $rejectedCount ?></div>
                <div class="sub-value"><?= te('Aplikasi ditolak') ?></div>
            </div>
            <div class="stat-card info">
                <h3><?= te('Tingkat Persetujuan') ?></h3>
        ...
        <div class="tabs-container">
            ...
            <div class="tab-content<?= $defaultTab === 'pending' ? ' active' : '' ?>" id="pending-tab">
                    ...
                    <div class="suppliers-grid">
                        ...
                        if ($pendingRes) {
                            while ($supplier = $pendingRes->fetch_assoc()):
                                ...
                                $approvalDate = !empty($supplier['approved_at']) ? date('d M Y', strtotime($supplier['approved_at'])) : te('Belum ditinjau');
                                $fullName = trim($supplier['first_name'] . ' ' . $supplier['last_name']);
                                $fullName = !empty($fullName) ? $fullName : te('Supplier Tidak Diketahui');
                                $statusText = $supplier['approved'] === null ? te('Belum Ditinjau') : te('Menunggu Peninjauan');
                                $supplierData = [
                                    'id' => $supplier['id_user'],
                                    'name' => $fullName,
                                ...
                                <div class="supplier-card">
                                    ...
                                    <div class="supplier-details">
                                        <div class="detail-row">
                                            ...
                                            <?= htmlspecialchars($supplier['email'] ?: te('Tidak ada email')) ?>
                                        </div>
                                        <div class="detail-row">
                                            <i class="material-icons">phone</i>
                                            <?= htmlspecialchars($supplier['no_hp'] ?: te('Tidak ada telepon')) ?>
                                        </div>
                                        <div class="detail-row">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <h3><?= te('Tidak Ada Permintaan Tertunda') ?></h3>
                        <p><?= te('Semua permintaan supplier telah diproses') ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="tab-content" id="approved-tab">
                        ...
                        ?>
                                <div class="supplier-card">
                                    ...
                                    <div class="approval-info">
                                        <div><?= te('Disetujui oleh:') ?> <strong><?= htmlspecialchars($approverName) ?></strong></div>
                                        <div><?= te('Disetujui pada:') ?> <?= $approvalDate ?></div>
                                    </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        <i class="material-icons">inbox</i>
                        <h3><?= te('Belum Ada Supplier Disetujui') ?></h3>
                        <p><?= te('Belum ada supplier yang disetujui') ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="tab-content" id="rejected-tab">
                    ...
                    <div class="suppliers-grid">
                        ...
                        ?>
                                <div class="supplier-card">
                                    ...
                                    <div class="approval-info">
                                        <div><?= te('Ditolak oleh:') ?> <strong><?= htmlspecialchars($rejecterName) ?></strong></div>
                                        <div><?= te('Ditolak pada:') ?> <?= $rejectionDate ?></div>
                                    </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        <i class="material-icons">inbox</i>
                        <h3><?= te('Tidak Ada Supplier Ditolak') ?></h3>
                        <p><?= te('Belum ada supplier yang ditolak') ?></p>
                    </div>
                <?php endif; ?>
            </div>
                    ...
                    <form method="post">
                        ...
                        <div class="owner-form-grid">
                            <div class="owner-form-group">
                                <label><?= te('Nama Depan') ?>*</label>
                                <input type="text" name="first_name" required>
                            </div>
                            <div class="owner-form-group">
                                <label><?= te('Nama Belakang') ?></label>
        ...
        <script>
            // te() is a PHP function and can't be called from client-side JS;
            // these carry the current language's translations into the page instead.
            const TV_T_PENDING_REVIEW = <?= json_encode(te('Menunggu Peninjauan')) ?>;
            const TV_T_NOT_REVIEWED_YET = <?= json_encode(te('Belum ditinjau')) ?>;
            ...
            function viewSupplierDetail(supplierData) {
                ...
                if (cleanStatusText === '') {
                    switch (supplierData.status) {
                        case 'pending':
                            cleanStatusText = TV_T_PENDING_REVIEW;
                            break;
                        case 'approved':
                ...
                let formattedDate = TV_T_NOT_REVIEWED_YET;
                if (supplierData.approved_at && supplierData.approved_at !== TV_T_NOT_REVIEWED_YET) {
