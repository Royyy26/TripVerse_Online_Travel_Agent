...
<body>
    ...
    <main class="main-content" id="main-content">
        ...
        <div class="performance-section">
            <h2><i class="material-icons">trending_up</i> Analisis Tren Pemesanan Hotel - TripVerse</h2>
        ...
        <div class="performance-section">
            <h2><i class="material-icons">timeline</i> Analisis Tren Pemesanan (6 Bulan Terakhir)</h2>
        ...
        <div class="performance-section">
            <h2><i class="material-icons">pie_chart</i> Market Share Analysis</h2>
        ...
        <div class="performance-section">
            <h2><i class="material-icons">leaderboard</i> 10 Hotel Berkinerja Terbaik</h2>
        ...
        <!-- PERFORMANCE BY CITY -->
        <div class="performance-section">
            <h2><i class="material-icons">location_city</i> Performance by City</h2>
        ...
        <div class="performance-section">
            <h2><i class="material-icons">hotel</i> Detailed Hotel Performance</h2>
